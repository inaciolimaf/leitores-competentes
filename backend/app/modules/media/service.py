            ...
            content=[
                {
                    ...
                    "text": (
                        ...
                        "3. EXISTE UM CABEÇALHO? (Nome, Data, Escola, Professora, campo 'NOME: _______', 'Leia o texto') -> REJEITE IMEDIATAMENTE.\n"
                        ...
                        "7. É UMA CAPA DE LIVRO OU GIBI? Se a imagem for uma capa (Título grande, logo de editora, sem balões de diálogo) -> REJEITE IMEDIATAMENTE.\n"
                        "8. BALÕES VAZIOS PARA PREENCHER? Se a imagem for um exercício de 'Complete os balões' (balões brancos e limpos, sem letras dentro) -> REJEITE IMEDIATAMENTE.\n\n"
                        "CRITÉRIO DE ACEITAÇÃO:\n"
                        "- APENAS a tirinha pura, charge ou imagem limpa.\n"
                        "- Deve haver texto legível DENTRO dos balões.\n"
                        "- O texto deve ser RICO o suficiente para gerar uma questão de interpretação.\n\n"
                        "RESPOSTAS PERMITIDAS:\n"
                        "- Se for atividade/exercício/capa/balão vazio: 'REJEITADA_ATIVIDADE'\n"
