            ...
            content=[
                {
                    ...
                    "text": (
                        ...
                        "7. É UMA CAPA DE LIVRO OU GIBI? Se a imagem for uma capa (Título grande, logo de editora como Panini/Maurício de Sousa, um único desenho grande sem balões de diálogo) -> REJEITE IMEDIATAMENTE. Queremos a HISTÓRIA, não a capa.\n\n"
                        "CRITÉRIO DE ACEITAÇÃO:\n"
                        "- APENAS a tirinha pura, charge ou imagem limpa.\n"
                        "- Deve haver uma sequência narrativa ou diálogo (balões de fala).\n"
                        ...
                        "- Se for atividade/exercício/capa: 'REJEITADA_ATIVIDADE'\n"
